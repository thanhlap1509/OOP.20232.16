...
public class MyPanel extends JPanel implements MouseListener {
    ...
    private int i;
    final Color COLOR = new Color(0,173,255);
    private String UoL;
    MyPanel(String ori){
    ...
    MyPanel(String ori, String uol, int i){
        this.addMouseListener(this);
        setBackground(COLOR);
        this.setPreferredSize(new Dimension(SIZE / 2 + MARGIN, (int) (SIZE*1.6)));
        this.orientation = ori;
        this.UoL = uol;
        this.i = i;
        this.setVisible(true);
    ...
    public void paint(Graphics g){
        ...
        switch (orientation) {
            case "left" -> {
                ...
                g2D.fillArc(MARGIN / 2 + 1, MARGIN + 1, SIZE - 4, (int) (SIZE * 1.2) - 2, 90, 180);
            ...
            case "right" -> {
                ...
                //come inside
                g2D.setPaint(Color.white);
                g2D.fillArc(-SIZE / 2 + MARGIN / 2 + 3, MARGIN + 1, SIZE - 4, (int) (SIZE * 1.2) - 2, 270, 180);
                g2D.setBackground(getBackground());
            }
            case "center" -> {
                if (UoL.equals("upper")) {
